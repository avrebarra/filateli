...
// ParseFrom parses file into environment
func (e *Environment) ParseFrom(rdr io.Reader) error {
...
func (e *Environment) upsertVariable(f Variable) {
	var update bool
...
func (e *Environment) SetCollectionVariables(vv []Variable) {
	for _, v := range vv {
		if !v.Disabled {
			e.upsertVariable(v)
		}
